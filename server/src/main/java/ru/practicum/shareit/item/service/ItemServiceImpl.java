...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDTO addItem(long userId, ItemDTO itemDTO) {
        ...
        Item savedItem = itemRepository.save(ItemMapper.toItem(itemDTO, user, itemRequest));
    ...
    public ItemUpdate updateItem(long userId, long itemId, ItemUpdate itemUpdate) {
        ...
        Long requestId = itemUpdate.getRequestId();
        ...
        if (requestId != null) {
            item.setItemRequest(itemRequestService.getRequestById(requestId));
        }
